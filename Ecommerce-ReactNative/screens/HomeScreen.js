...
const HomeScreen = () => {
  ...
  const [companyOpen, setCompanyOpen] = useState(false); // State for company dropdown
  ...
  const toggleColumns = () => {
    setNumColumns((prevColumns) => (prevColumns === 1 ? 2 : 1));
  };
      ...
      >
        <ScrollView>
          ...
          <View style={{ marginTop: 15 }}>
            <Button
              title={`Toggle to ${numColumns === 1 ? "2" : "1"} column(s)`}
